...
| `add <service> [--with-deps]` | `LH-FA-ADD-001..003`, `LH-FA-ADD-005..006` | Idempotent state-machine for service add-ons (`postgres`, `keycloak`); `--with-deps` auto-installs missing dependencies. |
