...
- ADRs sind nach `Accepted` **immutable** (siehe [Kurs Modul 4](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/01-spec-und-architektur/modul-04-architektur-adrs.md)).
...
- Jede ADR deklariert im `**Schärft:**`-Feld *aufwärts*, welche Spec-Stelle
  sie verbindlich macht ([Kurs §Referenz-Richtung](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/konventionen.md#referenz-richtung-sdp-wer-darf-wen-referenzieren)).
