...
<!-- Quelle: [03-agenten/modul-09-implementierung.md](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/03-agenten/modul-09-implementierung.md) -->
...
[`fallstudien.md`](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/fallstudien.md)):
...
- **Token-Kosten.** Jedes Token im Eingangskontext wird abgerechnet —
  ...
  [`quellen.md`](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/abschluss/quellen.md)), ist eine
