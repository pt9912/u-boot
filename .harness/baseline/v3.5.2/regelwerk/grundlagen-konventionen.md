## Konventionen
<!-- Quelle: [grundlagen/konventionen.md](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/konventionen.md) -->
...
(Beispiel `c-hsm-doc`, siehe [`fallstudien.md`](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/fallstudien.md)):
...
- **[`fallstudien.md` §Beobachtung aus dem Ist-Zustand](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/fallstudien.md#beobachtung-aus-dem-ist-zustand)**: die vier Beispiel-Repos in GF-/BF-Modus klassifiziert.
