...
<!-- Quelle: [00-einfuehrung/modul-00-einfuehrung.md](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/00-einfuehrung/modul-00-einfuehrung.md) -->
...
- In den dokumentierten Scheiterfällen war meist nicht das Modell die Ursache, sondern eine Spec-Lücke oder ein fehlender Sensor. Das Modell rät, *weil nichts in der Eingabe widerspricht*. Lopopolo (OpenAI 2026) und die Fallstudien in [`grundlagen/fallstudien.md`](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/fallstudien.md) belegen das.
