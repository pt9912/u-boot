...
<!-- Quelle: [01-spec-und-architektur/modul-02-harness-bootstrap.md](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/01-spec-und-architektur/modul-02-harness-bootstrap.md) -->
...
* Modus gilt **pro Sub-Area**. Ein Repo kann in den
  *Konventionen* BF und in der *Spec-Schreibung* GF sein. Die vier
  Beispiele in
  [`grundlagen/fallstudien.md` §Beobachtung aus dem Ist-Zustand](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/fallstudien.md#beobachtung-aus-dem-ist-zustand)
...
* Eine Struktur qualifiziert erst über die drei Inklusions-Achsen
  ...
  ([`grundlagen/lernervorstellungen.md` §Über Planung](https://github.com/pt9912/ai-harness-course/blob/v3.5.2/kurs/de/grundlagen/lernervorstellungen.md#über-planung-modul-57))
