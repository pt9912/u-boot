...
> **Status:** Done
> **DoD:** T1 ✅ `9f8badd` / T2 ✅ `84a676c` / T3 ✅ `1e5ef18` / T4 ✅ `1351cfb` (+ T4-fund `9101bdc`, + review `d1deee5`) / T5 ✅ `a46bec3` / T6 ✅ `4a7e60d` / T7 ✅ `6d9aa88` (+ review `adeea13`) / M6-closure-review ✅ `fb4a522` (4 Fixes: §970 fire-and-forget am Adapter, §237 Root-`--yes` für down, §968 Port-Probe bei healthcheck-required, `make test-docker`)
...
- [`slice-m6-docker-integrationstests`](../done/slice-m6-docker-integrationstests.md)
...
2. **T2 — `DockerEngine`-Driven-Port + Adapter + Fake.**
   ...
   - `internal/adapter/driven/docker/engine_test.go`: Build-Tagged
     ...
     [`slice-m6-docker-integrationstests`](slice-m6-docker-integrationstests.md)). M6 selbst legt nur die
