...
Entscheidung sinnvoll waren: [`slice-v1-template-list`](slice-v1-template-list.md),
[`slice-v1-template-init`](slice-v1-template-init.md), [`slice-later-local-templates`](slice-later-local-templates.md). Dieses
...
Port-/Adapter-Verdrahtung, gegen die [`slice-v1-template-init`](slice-v1-template-init.md) später
anbindet.

Spec-IDs: [`LH-FA-TPL-004`](../../../../spec/lastenheft.md#lh-fa-tpl-004--templates-auflisten) (Templates auflisten, V1) sowie
implizit [`LH-FA-TPL-002`](../../../../spec/lastenheft.md#lh-fa-tpl-002--template-metadaten) (Template-Metadaten — mindestens Name +
Beschreibung + Version sind in der Listing-Ausgabe sichtbar).

## Aufhebungsbedingung

`u-boot template list` listet alle eingebauten Templates aus dem
`embed.FS`-Katalog mit den [`LH-FA-TPL-004`](../../../../spec/lastenheft.md#lh-fa-tpl-004--templates-auflisten)-Pflichtfeldern (Name,
...
analog zur Mindestauslieferung in [ADR-0009](../../adr/0009-template-format-yaml-files.md) §Folgepunkte). Der
hexagonale Port `driven.TemplateCatalog` ist als
Lese-Schnittstelle gegen den [`slice-v1-template-init`](slice-v1-template-init.md)-Render-Pfad
wiederverwendbar.
...
- ✅ `u-boot template list --json` druckt ein JSON-Array
  ...
  mit allen [`LH-FA-TPL-002`](../../../../spec/lastenheft.md#lh-fa-tpl-002--template-metadaten)-Metadatenfeldern. Reihenfolge identisch
...
- ✅ Mindestens ein Built-in-Template (`basic`) liegt im Katalog
  als Bootstrap-Stand: `template.yaml` mit den [`LH-FA-TPL-002`](../../../../spec/lastenheft.md#lh-fa-tpl-002--template-metadaten)-
  Pflichtfeldern. Datei-Templates für den `basic`-Init-Pfad
  fügt [`slice-v1-template-init`](slice-v1-template-init.md) hinzu — dieser Slice braucht sie
  noch nicht (kein Render-Pfad).
- ✅ Exit-Codes per [`LH-FA-CLI-006`](../../../../spec/lastenheft.md#lh-fa-cli-006--exit-codes): 0 bei Erfolg, 14 bei
...
- `u-boot init --template <name>` Render-Pfad — eigener Slice
  [`slice-v1-template-init`](slice-v1-template-init.md) ([ADR-0009](../../adr/0009-template-format-yaml-files.md) §Folgepunkte 2).
- `u-boot init --template ./pfad` Filesystem-Auflösung — eigener
  Slice [`slice-later-local-templates`](slice-later-local-templates.md) ([ADR-0009](../../adr/0009-template-format-yaml-files.md) §Folgepunkte 3).
- Weitere Built-in-Templates über `basic` hinaus (`micronaut`,
  `sveltekit`, …) — kommen mit konkretem Bedarf in eigenen Slices
  ([ADR-0009](../../adr/0009-template-format-yaml-files.md) §Folgepunkte 4).
...
- Variable-Resolution / Render-Loop / `text/template`-Execution
  — gehört zum [`slice-v1-template-init`](slice-v1-template-init.md).
...
- Spec: [`LH-FA-TPL-002`](../../../../spec/lastenheft.md#lh-fa-tpl-002--template-metadaten) (Template-Metadaten), [`LH-FA-TPL-004`](../../../../spec/lastenheft.md#lh-fa-tpl-004--templates-auflisten)
  (Templates auflisten), beide V1 (`spec/lastenheft.md` §4.8).
- Roadmap: §Nächste Schritte Punkt 3 (V1-Templates-Implementation,
  drei [ADR-0009](../../adr/0009-template-format-yaml-files.md)-Slices). Mit T4 auf
  „[slice-v1-template-list](slice-v1-template-list.md) ✅ geliefert" aktualisiert.
- Architektur: hexagonale Schicht-Trennung ([`LH-FA-ARCH-001`](../../../../spec/lastenheft.md#lh-fa-arch-001--hexagonales-pattern)..[`LH-FA-ARCH-003`](../../../../spec/lastenheft.md#lh-fa-arch-003--import-regeln-und-enforcement)),
