...
`LH-QA-004` war bis M2 generisch („Linting (V1)") und das u-boot-Repo
...
- **Spec-Verschärfung**: `LH-QA-004` von „V1" auf MVP-Pflicht gehoben,
  Verweis auf `docs/user/quality.md` §1.2 / §1.3 als SSOT für Linter-
  Liste + Carveouts; `//nolint`-Pragmas verboten; Detail in ADR-0003.
...
- **ADR-0003** (`docs/plan/adr/0003-solid-nahes-lint-profil.md`):
...
- `LH-QA-004` MVP-Pflicht erfüllt; `LH-MVP-001` ergänzt.
- ADR-0003 verlinkt aus `quality.md`.

## Bezug

- Auslösende Spec: `LH-QA-004`.
