...
referenziert nicht-existenten Logging-Port, [ADR-0004](../../adr/0004-ci-system.md)-Folgepunkte wie
...
- **7 neue Slice-Pläne** in `open/` (ergänzten den bestehenden
  ...
  - [`slice-m3-coverage-threshold-aktivieren.md`](slice-m3-coverage-threshold-aktivieren.md) (jetzt in `done/`),
  - [`slice-m3-depguard-aktivierung-verifizieren.md`](slice-m3-depguard-aktivierung-verifizieren.md) (jetzt in `done/`),
  - `slice-v1-gomodguard-rules.md` (re-phasiert auf M3-followup, jetzt
    in `done/`),
  - `slice-v1-logging-port.md` (re-phasiert auf M4, in `open/`),
  - [`slice-v1-release-pipeline.md`](slice-v1-release-pipeline.md) (in `open/`),
  - `slice-v1-branch-protection-checkliste.md` (absorbiert in
    [`slice-v1-release-pipeline.md`](slice-v1-release-pipeline.md), Datei gelöscht),
  - `slice-v1-docker-integrationstests.md` (re-phasiert auf M6,
    umbenannt zu [`slice-m6-docker-integrationstests.md`](slice-m6-docker-integrationstests.md), in `open/`).
- **`slice-v1-retroaktive-slice-plaene.md`** (re-phasiert auf Later,
  umbenannt zu [`slice-m3-retroaktive-slice-plaene.md`](slice-m3-retroaktive-slice-plaene.md)) — meta-Slice für
