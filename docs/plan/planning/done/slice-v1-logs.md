...
Folge-Slice [`slice-v1-cli-json-dry-run`](slice-v1-cli-json-dry-run.md) nachträglich auf `logs`
drauf.
...
- **`--no-log-prefix` / `--timestamps`-Flags (Output-Format,
  ...
  *vor* dem [`slice-v1-cli-json-dry-run`](slice-v1-cli-json-dry-run.md)-Slice, weil
...
- **`--json`-Output:** lebt im Folge-Slice
  [`slice-v1-cli-json-dry-run`](slice-v1-cli-json-dry-run.md) (Roadmap-Notiz); diese Slice
...
- Roadmap: [`roadmap.md`](../in-progress/roadmap.md) §v0.4.0 —
  Bündelung mit [`slice-v1-cli-json-dry-run`](slice-v1-cli-json-dry-run.md).
