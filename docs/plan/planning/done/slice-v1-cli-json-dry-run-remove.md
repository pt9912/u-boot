...
- R15 (Post-T7 Bestätigung): HIGH=0, MED=0, LOW=2 + 1 Cross-Slice. LOW-1 + LOW-2 → T8-Code-Fixes (Sanitizer-Word-Boundary + TooMany-DryRun-Pin). Cross-Slice-1 → neuer open/-Stub [`slice-v1-cli-json-envelope-consolidation`](../next/slice-v1-cli-json-envelope-consolidation.md) + carveouts.md-Eintrag.
