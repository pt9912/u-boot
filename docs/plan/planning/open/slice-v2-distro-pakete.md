# Slice V2: Debian-/RPM-Pakete für u-boot (`LH-OPEN-002`-Restweg)
...
mögliche Distributionsoptionen für `LH-OPEN-002`. ADR-0007 hat
...
| T4 | Closure: CHANGELOG, carveouts.md `LH-OPEN-002`-Zeile entweder gelöscht (alle Restwege beliefert) oder reduziert, ADR-0007 §Entscheidung „Vertagt → Gewählt" für Debian/RPM. Slice-Plan `open/` → `done/`. |
...
- **Snap / Flatpak / AppImage**: nicht in `LH-OPEN-002` §14
...
- Geschwister-Slice:
  `slice-v2-homebrew-formula.md` (parallel auf hold; macOS-
