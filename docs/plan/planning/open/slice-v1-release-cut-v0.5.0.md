...
> `u-boot init --template ./pfad` (lokale User-Templates, `LH-FA-TPL-003`,
> [`done/slice-later-local-templates.md`](../done/slice-later-local-templates.md)).
> Alles andere seit v0.4.0 ist `docs(plan)` (ADR-0011/0012 Proposed,
...
> harmonised exit codes (`LH-FA-TPL-003`, ADR-0009). Details below.
...
- **ADR-0011/0012 ratifizieren**: bleiben Proposed; keine v0.5.0-Blocker.
...
- Inhalt: [`done/slice-later-local-templates.md`](../done/slice-later-local-templates.md)
  (`LH-FA-TPL-003`), [ADR-0009](../../adr/0009-template-format-yaml-files.md).
