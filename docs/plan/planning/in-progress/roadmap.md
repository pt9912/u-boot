...
| [`slice-later-local-templates`](../open/slice-later-local-templates.md) | `open/`, **in progress — T1–T4 done (`66c347d`/`87a8704`/`5031b5f`/`adaafbe`)** (Later) | `u-boot init --template ./pfad` funktional, getestet, dokumentiert (README EN+DE, CHANGELOG, ADR ✅). **Nur noch T5 (Closure: `open/`→`done/`).** `LH-FA-TPL-003`. |
