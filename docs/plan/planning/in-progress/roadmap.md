...
| [`slice-later-local-templates`](../open/slice-later-local-templates.md) | `open/`, **in progress — T1 done (`66c347d`)** (Later) | Fundament gebaut (`templateyaml`-Parser, `domain.ClassifyTemplateRef`, `ErrTemplateInvalid`, Symlink-Guard). Verbleibend T2–T5 (FS-Resolver+Composite, Wiring, E2E/Docs, Closure). `LH-FA-TPL-003`. |
