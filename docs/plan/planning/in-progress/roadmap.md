...
| M4 `u-boot doctor` | In progress | Lokale Voraussetzungen prüfen (`LH-FA-DIAG-001..004`), Severity-Klassifikation, Repair-Hints. Vorbereitende Slices erledigt: `slice-m4-soft-existing-detection`, `slice-m4-logging-port`. Detail: [`slice-m4-doctor.md`](slice-m4-doctor.md). **Stand:** T1..T7 offen | [`slice-m4-doctor`](slice-m4-doctor.md) |
