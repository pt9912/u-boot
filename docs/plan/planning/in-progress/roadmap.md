...
| M3 `u-boot init` | Next | Projektstruktur erzeugen (`LH-FA-INIT-001..007`), `u-boot.yaml` schreiben, Git-Init; erste produktive Pakete in `internal/`, depguard-Regelblöcke scharf schalten (siehe [`open/slice-m3-depguard-aktivierung-verifizieren.md`](../open/slice-m3-depguard-aktivierung-verifizieren.md)), Coverage-Schwelle anheben (siehe [`open/slice-m3-coverage-threshold-aktivieren.md`](../open/slice-m3-coverage-threshold-aktivieren.md)) | offen |
