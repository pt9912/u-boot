...
| V1 Add-on Expansion (v0.3.0-Milestone) | In Progress (3/5) | Fünf Slices als v0.3.0-Scope: ✅ [`slice-v1-audit-done`](../done/slice-v1-audit-done.md) (Doku-Audit für `LH-FA-BUILD-006`/`LH-NFA-MAINT-004`/`LH-NFA-PORT-003`), ✅ [`slice-v1-add-remove`](../done/slice-v1-add-remove.md) (`LH-FA-ADD-007`), ✅ [`slice-v1-addons-deps`](../done/slice-v1-addons-deps.md) (`LH-FA-ADD-006`), `slice-v1-keycloak` (`LH-FA-ADD-003` + `LH-AK-003`), `slice-v1-otel` (`LH-FA-ADD-004` + `LH-AK-004`). | partial — siehe done/ |
