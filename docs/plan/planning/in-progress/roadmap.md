...
| M8 `u-boot config` | Open | `config get`/`set`/Anzeigen (`LH-FA-CONF-001..005`), Schema-Validierung. Letzter MVP-blockierender Slice. | [`slice-m8-config`](../open/slice-m8-config.md) |
