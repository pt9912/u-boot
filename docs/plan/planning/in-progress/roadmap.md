...
| M3 `u-boot init` | In progress | Projektstruktur erzeugen (`LH-FA-INIT-001..007`), `u-boot.yaml` schreiben, Git-Init; Coverage-Carveout bereits aufgelöst, depguard-Verifikation folgt mit T5. Detail: [`slice-m3-init-flow.md`](slice-m3-init-flow.md). **Stand:** T1 ✅ `132d1a1` + `f5c784a`; T2 ✅ `aaf4d8d` + Review-Fixes `39387b9`; T3 ✅ `937adb1` (Cobra, ADR-0005, End-to-End-Smoke) + Review-Fixes; T4/T5 offen |
