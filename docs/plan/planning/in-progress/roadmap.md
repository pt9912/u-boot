...
| [`slice-m6-docker-integrationstests`](../in-progress/slice-m6-docker-integrationstests.md) | `//go:build docker`-Pfad nur dokumentiert, kein CI-Job; erst mit Docker-Adapter sinnvoll | M6 | Open |
...
1. **M6 up/down**: **Done** (siehe [`slice-m6-up-down.md`](../done/slice-m6-up-down.md)). Alle 7 Tranchen abgeschlossen: T1 ✅ `9f8badd`, T2 ✅ `84a676c`, T3 ✅ `1e5ef18`, T4 ✅ `1351cfb` (+ fund `9101bdc`, + review `d1deee5`), T5 ✅ `a46bec3`, T6 ✅ `4a7e60d`, T7 ✅ `6d9aa88` (+ review `adeea13` für `up --quiet`-Vertrag). Coverage 91.20%. Reale Docker-Engine-Verhaltens-Pins via Carveout-Slice [`slice-m6-docker-integrationstests`](../in-progress/slice-m6-docker-integrationstests.md). Aktive Phase: **M7 generate**.
