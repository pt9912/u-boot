...
| [`slice-gate-ids-link-policy-always`](../in-progress/slice-gate-ids-link-policy-always.md) | `ids` prüft auch Code-Spans; 100 Befunde gemessen, `exempt-paths`-Politik zu entscheiden | in-progress |
