...
| [`slice-later-local-templates`](../done/slice-later-local-templates.md) | **`done/`** (Later) | ✅ **`LH-FA-TPL-003` ausgeliefert** — `u-boot init --template ./pfad` (lokale FS-Templates). T1–T5 + Pre-T5-Review (`66c347d`/`87a8704`/`5031b5f`/`adaafbe`/`7d63532`/`T5_HASH`); Carveout in [`carveouts.md`](carveouts.md) §Auflösungs-Slices aufgelöst. |
