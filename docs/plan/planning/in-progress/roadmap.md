...
| M3 `u-boot init` | In progress | Projektstruktur erzeugen (`LH-FA-INIT-001..007`), `u-boot.yaml` schreiben, Git-Init; löst die zwei M3-Carveouts (Coverage-Schwelle, depguard-Verifikation) auf. Detail: [`slice-m3-init-flow.md`](slice-m3-init-flow.md) | in 5 Tranchen geplant |
