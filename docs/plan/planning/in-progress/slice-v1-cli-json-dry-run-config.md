...
> **Status:** `in-progress/` — **T6 done (2026-06-08, Acceptance-
> Tests)**, `make gates` grün (Coverage 91.30 %). T2–T6 geliefert:
...
> Worst-Case + Subcommand-Pflicht-Pin + Mid-Stage-Shapes (T6).
...
> Flag-Registrierung) sind in T5 gelandet. Nächster Schritt: **T7**
> (Review-Fix-Rounds + Pre-T8-Bestätigungsrunde; bei Hybrid-Slice
> höhere Review-Komplexität erwartet — ~150-250 LOC).
> R1+R2+R3-
