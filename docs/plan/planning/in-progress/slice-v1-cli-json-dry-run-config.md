...
> **Status:** `in-progress/` — **T5 done (2026-06-08, CLI-RunE-
> Layer)**, `make gates` grün (Coverage 91.20 %). T2–T5 geliefert:
...
> Flag-Registrierung) sind in T5 gelandet. Nächster Schritt: **T6**
> (Acceptance-Tests ~24-28: Mapper-Rows 1-10, Cobra-unknown-
> subcommand-Mechanik-Pin, LH-FA-CONF-005-Disambiguation,
> Mid-Stage-Snapshot, `--quiet --json`-Pins, Sanitizer-Worst-Case).
> R1+R2+R3-
