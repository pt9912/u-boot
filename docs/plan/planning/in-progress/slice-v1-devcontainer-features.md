...
**Go-LOC-Summe T1-T6 ≈ 920** (geschätzt nach Carveout: T1 150 + T2 100 + T3 200 + T4 250 + T5 120 + T6 100; Teil-B-150-LOC wandert in den Folge-Slice). **Real-LOC nach T4 + Review-Followup:** T1 ≈ 230 (+53 %), T2 ≈ 84 (−16 %), T3 ≈ 115 (−43 %), T4 ≈ 510 (+104 %), T4-Review-Followup R1..R6 ≈ 70 (Härtung Spec §720/§1353, atomare Reihenfolge, UX-Hinweise). **T1-T4-Summe inkl. Followup ≈ 1009 LOC > 800-Schwelle** — **Carveout-Trigger gefeuert.** Folge-Slice [`slice-followup-devcontainer-features-drift-doctor`](../open/slice-followup-devcontainer-features-drift-doctor.md) (~150 LOC) in `open/` angelegt; Doctor-Teil-B wandert dorthin. T5 in diesem Slice realisiert nur noch Teil A (`devcontainer.features.allowlist`, ~120 LOC). Vergleichswerte aus
[`slice-m5-add-postgres`](../done/slice-m5-add-postgres.md) +
